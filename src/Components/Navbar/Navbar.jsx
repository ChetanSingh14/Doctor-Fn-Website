  ...
  return (
    <nav className="flex flex-col lg:flex-row lg:h-24 bg-teal-800 justify-between items-center px-6 lg:px-16">
      <div className="bg-gray-700 text-white lg:ml-0 mb-6 lg:mb-0 lg:mr-6 lg:rounded-full lg:overflow-hidden">
        <img src="src/Images/logo.png" alt="logo" className="h-20 w-52" />
      </div>
      ...
      <div className="hidden lg:flex flex-col lg:flex-row items-center">
        <ul className="flex flex-col lg:flex-row list-none space-y-4 lg:space-y-0 lg:space-x-12 text-center lg:text-left">
          <li>
            <Link
              to="/"
              className={activeTab === "/" ? "text-green-200" : "text-white"}
          ...
          <li>
            <Link
              to="/about"
              className={
                activeTab === "/about" ? "text-green-200" : "text-white"
              }
          ...
          <li>
            <Link
              to="/services"
              className={
                activeTab === "/services" ? "text-green-200" : "text-white"
              }
          ...
          >
            <Link
              to="/info"
              className={
                activeTab === "/info" ? "text-green-200" : "text-white"
              }
            >
              Patient Info
            </Link>
            {showDropdown && (
              <div className="absolute bg-white py-2 px-4 rounded-lg top-8 left-0 z-10">
                <Link
                  to="/info"
                  className="block text-teal-800 hover:text-teal-600"
          ...
          <li className="text-white">
            <Link to="/patientReview">Patient Reviews</Link>
          ...
          <li>
            <Link
              to="/blog"
              className={
                activeTab === "/blog" ? "text-green-200" : "text-white"
              }
          ...
          <li>
            <Link
              to="/location"
              className={
                activeTab === "/location" ? "text-green-200" : "text-white"
              }
              onClick={() => handleSetActiveTab("/location")}
            >
              Location
            </Link>
          </li>
          <li>
            <Link
              to="/contact"
              className={
                activeTab === "/contact" ? "text-green-200" : "text-white"
              }
